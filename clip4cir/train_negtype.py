...
from models_negtype import CIRPlus
...
def main():
    ...
    model = CIRPlus(args.clip_model_name, tau=args.tau, transform=args.transform, device=device, neg_type=args.neg_type)
    if args.model_path:
            ...
            for idx, batch_data in enumerate(relative_train_loader):
                ...
                with autocast():
                    loss_dict = model.forward(captions, indexs, target_index_all,
                                              reference_index_all, reference_images, target_images)
...
if __name__ == '__main__':
    ...
    parser.add_argument("--neg_type", type=int, default=4)
